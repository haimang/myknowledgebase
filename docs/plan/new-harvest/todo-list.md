...
- [x] `NHX1-P8` [代码制作/测试/日志/提交] Shadow/cutover、compat drain、retirement/forward rollback（`P8-01..03`；`NHX1-T26` join compat tests）。`blocked-by: NHX1-P7=PASS` · evidence `5e775f7 / 32 passed / 2026-08-31T05:50:08Z`
- [!] `NHX1-P9` [assurance/测试/review/日志/提交] Compiler-derived L1–L4、deterministic races、real subprocess crash、persisted upgrade、full repo/evidence/third review（`P9-01..04`；`NHX1-T27..T30`）。工程 EXIT `d843f00 / 1010 passed`；`T22-O` 未签收，join blocked · `blocked-by: NHX1-P8=PASS + NHX1-T22-O=PASS`
- [!] `NHX1-FINAL-CLOSE` [最终本地审查/静态检查/closure/提交] 已按 `.adocs/templates/closure.md` 输出 closure 并完成本地复核；最终 verdict 仍 blocked，等待 `NHX1-T22-O`，不得伪造 full-close。`blocked-by: NHX1-P9=PASS + T22-O`
