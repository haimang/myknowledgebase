"""Code-owned, declarative single-intake LS-RAG workflow seed.

This module contains static typed data only.  Loading it validates the graph;
it neither schedules work nor accesses persistence, storage, models, or queues.
"""
...
# Compatibility definitions are intentionally *not* bootstrap candidates: new
# Tasks resolve the active v2 registry revision, while only an Execution whose
# immutable compiled digest matches this declaration may execute it.
