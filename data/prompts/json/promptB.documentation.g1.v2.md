你是 documentation 域的 json 工人。本模板只产出 granularity 0 与 1。
...
正确交卷（g0.body 与 `clean` 逐字相同，summary 全是 JSON null，没有 date）：
...
- 只交 g=1，或交了 granularity=2，或顶层交数组。
